...
test('defaultAdapter returns a complete adapter implementation', t => {
  ...
  t.deepEqual(methods, [
    'addClass', 'removeClass', 'hasClass', 'hasNecessaryDOM', 'registerComponentInteractionHandler',
    'deregisterComponentInteractionHandler', 'registerDrawerInteractionHandler', 'deregisterDrawerInteractionHandler',
    'registerTransitionEndHandler', 'deregisterTransitionEndHandler', 'setTranslateX',
    'updateComponentBackground', 'getFocusableElements', 'saveElementTabState', 'restoreElementTabState',
    'makeElementUntabbable', 'isRightSide'
  ]);
...
test('#init calls component and drawer event registrations', t => {
  ...
  foundation.init();
  t.doesNotThrow(() => td.verify(mockAdapter.registerComponentInteractionHandler('click', isA(Function))));
  ...
  t.doesNotThrow(() => td.verify(mockAdapter.registerComponentInteractionHandler('touchmove', isA(Function))));
  t.doesNotThrow(() => td.verify(mockAdapter.registerComponentInteractionHandler('touchend', isA(Function))));
  t.end();
});
...
test('#destroy calls component and drawer event deregistrations', t => {
  ...
  foundation.init();
  foundation.destroy();
  t.doesNotThrow(() => td.verify(mockAdapter.deregisterComponentInteractionHandler('click', isA(Function))));
  ...
  t.doesNotThrow(() => td.verify(mockAdapter.deregisterComponentInteractionHandler('touchmove', isA(Function))));
  t.doesNotThrow(() => td.verify(mockAdapter.deregisterComponentInteractionHandler('touchend', isA(Function))));
  t.end();
});
